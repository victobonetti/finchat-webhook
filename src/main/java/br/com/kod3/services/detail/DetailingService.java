...
public class DetailingService {
  ...
  public Detail getFormattedTransactions(String uid, LocalDate startDate, LocalDate endDate) {
    List<Transaction> userTransactions =
        transactionService.getTransactionsByUidAndPeriod(uid, startDate, endDate);
    ...
    return new Detail(
        tf.formatTransactionReport(
            userTransactions, expensesTotal.intValue(), incomesTotal.intValue()));
  }
